  ...
  return (
    <form className="flex flex-col gap-y-6" onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col gap-y-2">
        <label htmlFor="expense-amount" className="text-sm font-bold text-[#334155]">Amount</label>
        <input
          type="number"
          id="expense-amount"
          step="0.01"
      ...
      <div className="flex flex-col gap-y-2">
        <label htmlFor="expense-description" className="text-sm font-bold text-[#334155]">Description</label>
        <textarea
      ...
      <div className="flex gap-x-4">
        <div className="flex basis-[50%] flex-col gap-y-2">
          <label htmlFor="expense-category" className="text-sm font-bold text-[#334155]">Category</label>
          <input
            type="text"
            id="expense-category"
            className="p-3 border border-[#E2E8F0] rounded-[12px]"
        ...
        <div className="flex basis-[50%] flex-col gap-y-2">
          <label htmlFor="expense-date" className="text-sm font-bold text-[#334155]">Date</label>
          <input
            type="date"
            id="expense-date"
            className="p-3 border border-[#E2E8F0] rounded-[12px]"
